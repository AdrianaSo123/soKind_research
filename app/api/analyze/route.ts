...
1. **Pain Points**: Identify usability violations and their severity (Critical/High/Medium). Explain which heuristic is violated and why it matters to users.

2. **Motivations**: Uncover what users are trying to accomplish and why. Connect behaviors to underlying goals and needs.

3. **Themes**: Find patterns in user feedback. Each theme should connect to a UX principle and include supporting quotes.

4. **Personas**: Create realistic personas based on actual behaviors (not aspirations). Include context, mental models, and representative quotes.
...
5. **Affinity Groups**: Cluster raw observations, quotes, and feedback by natural thematic similarity - NOT by framework categories like "pain points" or "journey stages". Think of this like organizing sticky notes on a wall:
   ...
   - Each cluster should contain 4-8 specific observations, quotes, or data points from the research
   - Aim for 5-8 clusters total
...
6. **Recommendations**: Provide specific, prioritized actions. Explain the design principle behind each recommendation in simple terms.
